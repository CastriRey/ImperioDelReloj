...
urlpatterns = [
    ...
    path('relojes_cliente/', listar_relojes_todos_clientes),
    path('relojes_cliente/crear/', crear_reloj_cliente),
    path('relojes_cliente/<int:cliente_id>/', listar_relojes_cliente),
